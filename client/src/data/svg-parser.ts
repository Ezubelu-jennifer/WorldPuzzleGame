...
export function extractNigeriaRegions(svgData: string) {
  ...
  const knownPaths: Record<string, string> = {
    ...
    // Updated FCT path with centroid at approximately (382, 369)
    "Federal Capital Territory": "M378.5,363.0L380.0,364.5L381.5,366.0L383.0,367.5L384.5,369.0L385.0,371.0L384.0,373.0L382.0,374.5L380.0,375.0L378.0,373.0L377.0,370.0L376.0,367.0L377.0,365.0L378.5,363.0z",
