    ...
    >
      ...
      >
        <path 
          ...
          strokeWidth="1" // Lighter stroke width like in the screenshot
          style={{ 
            filter: isDragging ? 'drop-shadow(0px 6px 12px rgba(0,0,0,0.5))' : 'drop-shadow(0px 1px 3px rgba(0,0,0,0.2))',
